...
type FillableIconProps = IconProps & {
  filled?: boolean;
};
        ...
        <nav className="mb-6">
          <ol className="flex items-center space-x-1 text-sm">
            ...
            <li>
              <a
                href="#"
                className="capitalize text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"
              >
                {product.category}
              </a>
            </li>
